...
cmd({
    ...
    desc: "Get 𓆩𝐙𝐀𝐈𝐃𝐈-𝐌𝐃𓆪 deploy link and information",
    react: "📂",
    category: "main",
    filename: __filename,
},
async (conn, mek, m, { from, reply, userConfig }) => {
    try {
        ...
        const BOT_NAME = userConfig?.BOT_NAME || config.BOT_NAME || '𓆩𝐙𝐀𝐈𝐃𝐈-𝐌𝐃𓆪';
        const OWNER_NAME = userConfig?.OWNER_NAME || config.OWNER_NAME || 'ZAIDI MD';
